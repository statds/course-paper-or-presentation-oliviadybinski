\documentclass[12pt]{article}
 ...
 \begin{titlepage}
   \begin{center}
    \vspace*{1cm}
    \Huge
    \textbf{Music Therapy and its Affect on Depression}
    \large
    \vspace{1cm}
    How Different Variables Affect Depression Scores in Individuals, and Which Set of Variables Provide the Best Outcomes
    \vspace{1.5cm}
    December 2022
    \vspace{0.8cm}
    \textbf{Olivia Dybibnski}
    \vspace{0.8cm}
    \Large
