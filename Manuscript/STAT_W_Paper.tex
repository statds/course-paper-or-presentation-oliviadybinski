...
\end{abstract}
 ...
 Specifically, the data collected had various variables about the study taken note of, such as if the therapy was individual or group, active or receptive, the average age of participants and how much time was spent total in therapy throughout the sessions. Finding out which variables are more likely to yield better results will aid in figuring out treatment options and treatment plans for people looking to work their depression. In this paper I will focus on how different variables affect how efective music therapy is for individuals with depression, and whether or not music therapy has an overall positive effect on depression.
 ...
 \begin{figure}[h!]
   \centering
   \includegraphics[width=17cm]{CHART2.png}
   \label{fig:chart2}
   \caption{Barplot}
 \end{figure}
 ...
 \begin{figure}[hbt!]
   \centering
   \includegraphics[width=17cm]{CHART3.png}
   \label{fig:chart3}
   \caption{Scatterplot}
 \end{figure}
